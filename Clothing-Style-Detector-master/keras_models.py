...
def clothing_category(path):
    ...
    #result_vgg = vgg_model.predict(test_image_resnet)
    #result_inception = inception_model.predict(test_image_resnet)
    #-------------------------------------------------------------
    #result_mobilenet = mobilenet_model.predict(test_image_resnet)
    #--------------------------------------------------------------
    label = decode_predictions(result_resnet)
    #---------------------------------------------------------------
    #label = decode_predictions(result_inception)
    #--------------------------------------------------------------
    print(label[0])
    print(label[0][0])
    prediction = ""
