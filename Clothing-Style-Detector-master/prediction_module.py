...
def clothing_color_pattern(path):
    ...
    #load pattern model
    pattern_model = load_model('.\weights\pattern.h5')
    #load color model
    color_model = load_model('.\weights\color.h5')
    ...
    #test_image_resnet = image.load_img(path, target_size = (299, 299))
    ...
    #result_resnet = vgg_model.predict(test_image_resnet)
