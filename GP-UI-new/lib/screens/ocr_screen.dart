...
class OCR extends StatefulWidget {
  @override
  OCRscreen createState() => OCRscreen();
}
...
//outputPage(output, ocr.pickedImage)));
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => outputPage(output, ocr.pickedImage)));
  }
...
class _outputPageState extends State<outputPage> with TickerProviderStateMixin {
  ...
  /*Future addImage() async {
    ...
    Reference ref = firebaseStorageRef.ref().child(myimage);

    downloadUrl =
        "https://firebasestorage.googleapis.com/v0/b/las-prod-1.appspot.com/o/${myimage}?alt=media";
    final UploadTask task = ref.putFile(widget.pickedImage);
    setData();
  }*/
  ...
  /*setData() {
    ...
    InfoImage user = new InfoImage(downloadUrl, speakable);
