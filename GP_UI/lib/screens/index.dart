...
class _MyHomePageState extends State<MyHomePage> {
  ...
  String _welcometext =
      "Hello, This is Blind assistant application. If you want to make any order, hold a long press on the screen ,and then speak your order.If you want to know what page you are on, double tap the screen. If you want to login in, say login.If you want to register,say register.";
