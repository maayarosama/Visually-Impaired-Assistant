...
import 'package:best_flutter_ui_templates/view/FacePainter.dart';
...
import 'package:best_flutter_ui_templates/view/auth_signUp.dart';
...
class MySignUpPage extends StatefulWidget {
  ...
  const MySignUpPage({Key key, @required this.cameraDescription})
      : super(key: key);
...
class SignUpState extends State<MySignUpPage> {
  String imagePath;
  Face faceDetected;
  Size imageSize;
