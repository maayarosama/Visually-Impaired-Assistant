...
class DetectFood extends StatefulWidget {
  final String option;
  const DetectFood({Key key, @required this.option}) : super(key: key);
  @override
  _DetectFoodState createState() => new _DetectFoodState(option: this.option);
}

class _DetectFoodState extends State<DetectFood> with TickerProviderStateMixin {
  ...
  Future predict(File image) async {
    ...
    print("[DEBUG IBRAHIM AFTER]");
    print(recognitions);
    print("[DEBUG IBRAHIM AFTERrrr]");
