...
class Currencyoutput extends StatefulWidget {
  @override
  final String output;
  final File pickedImage;
  //String downloadUrl=pickedImage.path;
  const Currencyoutput(
      {Key key, @required this.output, @required this.pickedImage})
      : super(key: key);

  _CurrencyoutputPageState createState() => _CurrencyoutputPageState();
}

class _CurrencyoutputPageState extends State<Currencyoutput>
