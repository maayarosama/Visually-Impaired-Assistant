...
import 'package:best_flutter_ui_templates/ModelView/sign_up_screen.dart';
...
import 'package:best_flutter_ui_templates/ModelView/sign_in_screen.dart';
...
import 'package:best_flutter_ui_templates/ModelView/admin_screen.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  String _welcometext =
      "Hello, This is Blind assistant application. If you want to make any order, hold a long press on the screen ,and then speak your order. If you want to login , say login.If you want to register,say register.";
